...
public class CheckFeedOfFoundItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_feed_of_found_items);
    ...
    private void GetDataFromFirebase() {
        ...
        Query query = myRef.child("Found Item Posts");
